...
public class Human {
    ...
    public void humanTurn() {
        ...
        while (true) {
            ...
            if (map.isCellFree(columnNumber, rowNumber)) {
                break;
            }
            System.out.printf("Ячейка с координатами: %d:%d уже занята%n%n", columnNumber + 1, rowNumber + 1);
        }
        map.drawMap(columnNumber, rowNumber, map.getDOT_HUMAN());
